...
function Footer() {
    return (
        <footer className="footer footer-center bottom-0 p-10 bg-base-200 text-base-content rounded">
            ...
            <aside>
                <p>Copyright © 2023 - All right reserved by Leonardo Couñago Arballo</p>
            </aside>
        </footer>
